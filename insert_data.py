# Qual a melhor forma de fazer UPDATE? Sem haver necessidade de fazer flush nas tabelas e subir o código novamente.
...
def insert_data():
    ...
    def insert_data():
        ...
        for elements in characters_as:
            ...
            character_name = current_character_name[1]
            c = Character(character_name=character_name) # inserir o personagem no banco de dados (colocar em django)
            c.save()
